...
train_labels = torch.tensor(
    train_data.SalePrice.values, dtype=torch.float32).view(-1, 1)
...
def train_and_pred(train_features, test_features, train_labels, test_data,
    ...
    submission.to_csv(
        '/home/charles/charles/python/pytorch/project/basis/instance/kaggle/Housing-Prices/data/submission.csv', index=False)
